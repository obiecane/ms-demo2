...
import com.ms.core.exception.ParamDecryptException;
...
public class EncodeUtils {
     ...
     * @date 2019/9/18 17:19
     **/
    public static String paramDecrypt(String key, String value) throws ParamDecryptException {
        if (value.length() % 6 > 0) {
            throw new ParamDecryptException("内容被篡改");
        }
